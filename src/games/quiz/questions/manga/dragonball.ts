...
export const dragonball = universe("manga", "Dragon Ball", [
  ...
  { id: "db-m3", d: 2, t: "Quel vieux maître arts martiaux entraîne Goku au début ?", a: "Tortue Géniale", acc: ["tortue geniale", "muten roshi", "roshi"], x: ["Kaio", "Korin", "Piccolo"] },
  ...
  { id: "db-d3", d: 3, t: "Quelle est l'attaque signature de Vegeta au début de Z ?", a: "Galick Gun", acc: ["galick gun", "canon galaxik"], x: ["Kamehameha", "Final Flash", "Big Bang Attack"] },
  ...
  { id: "db-d7", d: 3, t: "Comment nomme-t-on la transformation bleue ?", a: "Super Saiyan Blue", acc: ["super saiyan blue", "ssgss", "blue"], x: ["Super Saiyan 4", "Ultra Instinct", "Golden Freezer"] },
  ...
  { id: "db-p4", d: 4, t: "Quel Kaio entraîne Goku dans l'au-delà ?", a: "Le Kaio du Nord", acc: ["kaio du nord", "king kai", "kaio"], x: ["Tortue Géniale", "Korin", "Grand Kaio"] },
  { id: "db-p5", d: 4, t: "Quelle technique de téléportation Goku apprend-il sur la planète Yardrat ?", a: "Le Déplacement instantané", acc: ["deplacement instantane", "shunkan ido", "shunkan idou"], x: ["Kaioken", "Hiraishin", "Instant Flash"] },
  ...
  { id: "db-p7", d: 4, t: "Quelle attaque de Goku rassemble l'énergie de tous les êtres vivants ?", a: "Le Genkidama", acc: ["genkidama", "sphere de force", "spirit bomb"], x: ["Kamehameha", "Galick Gun", "Final Flash"] },
  ...
  { id: "db-p10", d: 4, t: "Comment appelle-t-on la forme la plus pure et enfantine de Boo ?", a: "Kid Boo", acc: ["kid boo", "boo originel", "boo pur"], x: ["Super Boo", "Fat Boo", "Evil Boo"] },
  ...
  { id: "db-p13", d: 4, t: "Quel assassin de l'Univers 6 utilise un saut dans le temps ?", a: "Hit", x: ["Cabba", "Frost", "Magetta"] },
  ...
  { id: "db-p17", d: 4, t: "Quel est le premier grand ennemi démoniaque de la série Dragon Ball originale ?", a: "Piccolo Daimao", acc: ["piccolo daimao", "grand demon piccolo"], x: ["Cell", "Freezer", "Boo"] },
  ...
  { id: "db-p20", d: 4, t: "Quel appareil inventé par Bulma sert à localiser les Dragon Balls ?", a: "Le Radar", acc: ["radar", "dragon radar"], x: ["Le Scouter", "La Capsule", "Le Radar Namek"] },
]);
