...
export const aot = universe("manga", "L'Attaque des Titans", [
  ...
  // --- Moyennes (10) ---
  { id: "aot-m1", d: 2, t: "Qui est considéré comme le soldat le plus fort de l'humanité ?", a: "Livaï Ackerman", acc: ["levi", "livai", "livai ackerman"], x: ["Erwin", "Mike", "Eren"] },
  ...
  { id: "aot-d13", d: 3, t: "Combien de Titans « Primordiaux » existe-t-il ?", a: "9", acc: ["neuf"], x: ["7", "13", "5"] },
  { id: "aot-d14", d: 3, t: "Quel Titan « roi » Eren obtient-il en plus du Titan Assaillant ?", a: "Le Titan Originel", acc: ["titan originel", "fondateur", "originel"], x: ["Le Colossal", "Le Bestial", "Le Marteau"] },
  { id: "aot-d15", d: 3, t: "Quelle jeune femme proche d'Historia se transforme en petit Titan ?", a: "Ymir", x: ["Annie", "Sasha", "Mikasa"] },

  // --- Pro (20) ---
  { id: "aot-p1", d: 4, t: "Comment s'appelle le Titan principal d'Eren ?", a: "Le Titan Assaillant", acc: ["titan assaillant", "attaquant", "attack titan"], x: ["Le Titan Originel", "Le Colossal", "Le Mâchoire"] },
  ...
  { id: "aot-p5", d: 4, t: "Combien d'années vit un détenteur des Titans des Neuf ?", a: "13 ans", acc: ["13", "13 ans", "treize"], x: ["7 ans", "20 ans", "50 ans"] },
  ...
  { id: "aot-p12", d: 4, t: "Comment appelle-t-on la dimension reliant tous les Eldiens, où réside Ymir ?", a: "Le Chemin", acc: ["le chemin", "coordonnees", "paths"], x: ["Le Mur", "Le Sous-sol", "Marley"] },
  ...
  { id: "aot-p14", d: 4, t: "Comment se nomme le plan apocalyptique d'Eren pour piétiner le monde ?", a: "Le Grand Terrassement", acc: ["grand terrassement", "rumbling"], x: ["L'Assaut Final", "La Purge", "Le Déluge"] },
  ...
  { id: "aot-p18", d: 4, t: "Quel est le salut militaire emblématique du Bataillon ?", a: "« Dévouez vos cœurs ! »", acc: ["devouez vos coeurs", "sasageyo"], x: ["« Pour le roi ! »", "« Liberté ! »", "« Pour Sina ! »"] },
