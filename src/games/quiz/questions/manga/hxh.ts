...
export const hxh = universe("manga", "Hunter x Hunter", [
  ...
  { id: "hxh-f4", d: 1, t: "Quelle licence prestigieuse les personnages cherchent-ils à obtenir ?", a: "Hunter", acc: ["hunter", "chasseur"], x: ["Ninja", "Pirate", "Alchimiste"] },
  ...
  { id: "hxh-m6", d: 2, t: "Comment s'appelle la célèbre organisation de voleurs à l'araignée ?", a: "La Brigade Fantôme", acc: ["brigade fantome", "genei ryodan", "araignee"], x: ["Les Zoldyck", "Le clan Kurta", "La Mafia"] },
  ...
  { id: "hxh-d2", d: 3, t: "À quelle catégorie de Nen appartient Killua ?", a: "Transformation", acc: ["transformation", "transmuteur", "transmutation"], x: ["Renforcement", "Émission", "Manipulation"] },
  { id: "hxh-d3", d: 3, t: "Comment s'appelle la technique électrique ultime de Killua ?", a: "Godspeed", acc: ["godspeed", "kanmuru"], x: ["Jajanken", "Chain Jail", "Bungee Gum"] },
  ...
  { id: "hxh-d13", d: 3, t: "Comment s'appelle la tour où l'on combat pour gravir les étages et gagner de l'argent ?", a: "La Tour Céleste", acc: ["tour celeste", "heavens arena"], x: ["Las Noches", "Le Colisée", "La Tour de Babel"] },
  ...
  { id: "hxh-d15", d: 3, t: "Quel cadet de Killua a des pouvoirs de vœux extrêmement dangereux ?", a: "Alluka", x: ["Kalluto", "Milluki", "Illumi"] },

  // --- Pro (20) ---
  { id: "hxh-p1", d: 4, t: "À quelle catégorie de Nen appartient Kurapika ?", a: "Matérialisation", acc: ["materialisation", "conjuration", "conjurer"], x: ["Renforcement", "Émission", "Manipulation"] },
  ...
  { id: "hxh-p8", d: 4, t: "Comment Meruem meurt-il finalement ?", a: "Empoisonné", acc: ["empoisonne", "poison", "empoisonnement"], x: ["Tué par Gon", "Tué par Killua", "De vieillesse"] },
  { id: "hxh-p9", d: 4, t: "Quel sacrifice ultime Netero utilise-t-il contre Meruem ?", a: "La Rose Miniature", acc: ["rose miniature", "la rose", "poor man's rose", "bombe"], x: ["Le Zero Hand seul", "Un Kamehameha", "Le Bungee Gum"] },
  { id: "hxh-p10", d: 4, t: "Comment s'appelle l'attaque de Netero aux cent types de mains ?", a: "Le Hyakushiki Kannon", acc: ["hyakushiki kannon", "cent types", "kannon"], x: ["Jajanken", "Godspeed", "Bungee Gum"] },
  { id: "hxh-p11", d: 4, t: "Que sacrifie Gon pour obtenir une puissance monstrueuse contre Neferpitou ?", a: "Tout son potentiel de Nen", acc: ["son avenir", "son potentiel", "son nen"], x: ["Un bras", "Ses souvenirs", "La vie de Killua"] },
  ...
  { id: "hxh-p16", d: 4, t: "Comment s'appelle le pouvoir de Chrollo qui vole les Nen des autres dans un livre ?", a: "Skill Hunter", acc: ["skill hunter", "bandit's secret", "bandits secret"], x: ["Bungee Gum", "Chain Jail", "Jajanken"] },
  ...
  { id: "hxh-p18", d: 4, t: "Sur quelle île Gon a-t-il grandi ?", a: "Whale Island", acc: ["whale island", "ile de la baleine", "baleine"], x: ["Yorknew", "Padokea", "Kukuroo"] },
