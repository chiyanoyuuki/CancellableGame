...
export const onepiece = universe("manga", "One Piece", [
  ...
  { id: "op-f3", d: 1, t: "Quel fruit du démon a mangé Luffy ?", a: "Le Gomu Gomu no Mi", acc: ["gomu gomu", "caoutchouc"], x: ["Le Mera Mera no Mi", "Le Hie Hie no Mi", "Le Yami Yami no Mi"] },
  ...
  // --- Dures (15) ---
  { id: "op-d1", d: 3, t: "Quel Empereur surnommé « l'homme le plus fort » meurt à Marineford ?", a: "Barbe Blanche", acc: ["barbe blanche", "edward newgate"], x: ["Kaido", "Shanks", "Gol D. Roger"] },
  ...
  { id: "op-d7", d: 3, t: "Quel amiral à la magma tue Ace ?", a: "Akainu", acc: ["akainu", "sakazuki"], x: ["Aokiji", "Kizaru", "Fujitora"] },
  ...
  { id: "op-d13", d: 3, t: "Quel Empereur peut se transformer en immense dragon ?", a: "Kaido", x: ["Big Mom", "Shanks", "Barbe Noire"] },
  { id: "op-d14", d: 3, t: "Quelle Impératrice gourmande règne sur Whole Cake Island ?", a: "Big Mom", acc: ["big mom", "charlotte linlin"], x: ["Boa Hancock", "Nico Robin", "Jewelry Bonney"] },
  ...
  { id: "op-p2", d: 4, t: "Quel second fruit Barbe Noire vole-t-il à Barbe Blanche ?", a: "Le Gura Gura no Mi", acc: ["gura gura"], x: ["Le Yami Yami no Mi", "Le Goro Goro no Mi", "Le Magu Magu no Mi"] },
  ...
  { id: "op-p4", d: 4, t: "Quel Haki permet de pressentir les mouvements et intentions ?", a: "Le Haki de l'observation", acc: ["observation", "kenbunshoku"], x: ["Le Haki de l'armement", "Le Haki des Rois", "Le Geppo"] },
  { id: "op-p5", d: 4, t: "Quel Haki, réservé aux futurs rois, peut faire perdre connaissance ?", a: "Le Haki des Rois", acc: ["haki des rois", "haoshoku"], x: ["Le Kenbunshoku", "Le Busoshoku", "Le Rokushiki"] },
  { id: "op-p6", d: 4, t: "À quelle espèce appartient Jinbe ?", a: "Homme-poisson", acc: ["homme poisson", "homme-poisson"], x: ["Sirène", "Géant", "Vison"] },
  { id: "op-p7", d: 4, t: "Comment appelle-t-on le peuple animal de Zou ?", a: "Les Visons", acc: ["visons", "mink"], x: ["Les Hommes-poissons", "Les Géants", "Les Tontatta"] },
