...
export const pokemon = universe("jeuxvideo", "Pokémon", [
  ...
  { id: "pkm-f4", d: 1, t: "Lequel de ces starters est de type Feu ?", a: "Salamèche", acc: ["salameche"], x: ["Bulbizarre", "Carapuce", "Pikachu"] },
  { id: "pkm-f5", d: 1, t: "Comment s'appelle le héros de l'anime Pokémon ?", a: "Sacha", x: ["Régis", "Pierre", "Ondine"] },
  ...
  { id: "pkm-d5", d: 3, t: "Quel Pokémon violet créé en laboratoire est réputé parmi les plus puissants ?", a: "Mewtwo", x: ["Mew", "Ectoplasma", "Giratina"] },
  { id: "pkm-d6", d: 3, t: "Comment s'appelle la région de la 2e génération ?", a: "Johto", x: ["Hoenn", "Sinnoh", "Unys"] },
  ...
  { id: "pkm-d8", d: 3, t: "Quel est le tout premier Pokémon du Pokédex national ?", a: "Bulbizarre", x: ["Pikachu", "Salamèche", "Mew"] },
  { id: "pkm-d9", d: 3, t: "De quels types est Dracaufeu ?", a: "Feu et Vol", acc: ["feu/vol", "feu et vol", "feu vol"], x: ["Feu et Dragon", "Feu uniquement", "Feu et Sol"] },
  ...
  { id: "pkm-d15", d: 3, t: "Quel Pokémon Spectre/Poison ricaneur est la forme finale de Fantominus ?", a: "Ectoplasma", acc: ["ectoplasma", "gengar"], x: ["Spectrum", "Feuforêve", "Osselait"] },
  ...
  { id: "pkm-p3", d: 4, t: "Comment s'appelle la région de la 4e génération ?", a: "Sinnoh", x: ["Hoenn", "Unys", "Kalos"] },
  ...
  { id: "pkm-p16", d: 4, t: "Quel Pokémon canard jaune déclenche ses pouvoirs psy quand il a mal à la tête ?", a: "Psykokwak", acc: ["psykokwak", "psyduck"], x: ["Canarticho", "Coudlangue", "Ramoloss"] },
  { id: "pkm-p17", d: 4, t: "Quel jeune homme mystérieux, roi de la Team Plasma, veut « libérer » les Pokémon ?", a: "N", x: ["Ghetis", "Cyrus", "Guzma"] },
