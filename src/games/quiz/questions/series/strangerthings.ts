...
export const strangerthings = universe("series", "Stranger Things", [
  // --- Faciles (5) ---
  { id: "st-f1", d: 1, t: "Comment surnomme-t-on la jeune fille aux pouvoirs psychiques et au crâne rasé ?", a: "Eleven", acc: ["eleven", "onze", "el"], x: ["Max", "Nancy", "Robin"] },
  { id: "st-f2", d: 1, t: "Comment appelle-t-on la dimension parallèle et sombre ?", a: "Le Monde à l'Envers", acc: ["monde a l'envers", "upside down"], x: ["Le Void", "La Zone", "L'Autre Côté"] },
  ...
  { id: "st-d5", d: 3, t: "Quelle immense créature d'ombre domine la saison 2 ?", a: "Le Flagelleur Mental", acc: ["mind flayer", "flagelleur mental"], x: ["Le Démogorgon", "Vecna", "Le Démochien"] },
  ...
  { id: "st-d11", d: 3, t: "Quel meneur du club Hellfire, guitariste, apparaît en saison 4 ?", a: "Eddie Munson", acc: ["eddie", "munson"], x: ["Steve", "Billy", "Argyle"] },
  { id: "st-d12", d: 3, t: "Quelle chanson sauve Max de l'emprise de Vecna ?", a: "« Running Up That Hill »", acc: ["running up that hill", "kate bush"], x: ["Master of Puppets", "Africa", "Thriller"] },
  ...
  // --- Pro (20) ---
  { id: "st-p1", d: 4, t: "Quel autre sujet du laboratoire, rencontré à Chicago, se fait appeler Kali ?", a: "Huit", acc: ["huit", "008", "kali"], x: ["Neuf", "Deux", "Sept"] },
  ...
  { id: "st-p5", d: 4, t: "Quelle est l'identité humaine de Vecna ?", a: "Henry Creel", acc: ["henry creel", "un", "001", "henry"], x: ["Brenner", "Billy", "Peter"] },
  { id: "st-p6", d: 4, t: "Quel numéro portait Vecna au laboratoire ?", a: "Un", acc: ["un", "001"], x: ["Onze", "Huit", "Deux"] },
  { id: "st-p7", d: 4, t: "Quel bébé-monstre Dustin adopte-t-il avant qu'il ne grandisse ?", a: "Dart", acc: ["dart", "d'artagnan", "dartagnan"], x: ["Démogorgon", "Mews", "Yertle"] },
  { id: "st-p8", d: 4, t: "Comment s'appelle la petite amie geek de Dustin ?", a: "Suzie", x: ["Erica", "Robin", "Max"] },
  ...
  { id: "st-p14", d: 4, t: "Comment appelle-t-on les créatures quadrupèdes en meute issues du Démogorgon ?", a: "Les Démochiens", acc: ["demochiens", "demodogs"], x: ["Les Démogorgons", "Les chauves-souris", "Vecna"] },
