...
export const got = universe("series", "Game of Thrones", [
  ...
  { id: "got-m10", d: 2, t: "Quel animal est l'emblème de la maison Stark ?", a: "Le loup géant", acc: ["loup geant", "direwolf", "loup"], x: ["Le lion", "Le dragon", "Le cerf"] },
  ...
  { id: "got-d6", d: 3, t: "Comment appelle-t-on le massacre du mariage où périt Robb Stark ?", a: "Les Noces Pourpres", acc: ["noces pourpres", "red wedding"], x: ["Les Noces Noires", "La Bataille de la Néra", "Les Noces de Sang"] },
  ...
  { id: "got-d13", d: 3, t: "Qui commande les Immaculés ?", a: "Ver Gris", acc: ["ver gris", "grey worm"], x: ["Daario", "Missandei", "Jorah"] },
  ...
  // --- Pro (20) ---
  { id: "got-p1", d: 4, t: "Comment s'appelle la capitale, siège du Trône de Fer ?", a: "Port-Réal", acc: ["port-real", "port real", "king's landing"], x: ["Winterfell", "Peyredragon", "Villevieille"] },
  { id: "got-p2", d: 4, t: "Comment s'appelle le château des Stark ?", a: "Winterfell", x: ["Port-Réal", "Peyredragon", "Vivesaigues"] },
  { id: "got-p3", d: 4, t: "En combien de royaumes Westeros est-il divisé ?", a: "7", acc: ["sept"], x: ["5", "9", "12"] },
  ...
  { id: "got-p8", d: 4, t: "Qui est le chef des Marcheurs Blancs ?", a: "Le Roi de la Nuit", acc: ["roi de la nuit", "night king"], x: ["Craster", "Mance Rayder", "Le Grand Autre"] },
  { id: "got-p9", d: 4, t: "Qui tue le Roi de la Nuit ?", a: "Arya Stark", acc: ["arya"], x: ["Jon Snow", "Bran", "Brienne"] },
  { id: "got-p10", d: 4, t: "Quel ordre d'assassins « sans visage » Arya rejoint-elle à Braavos ?", a: "Les Sans-Visage", acc: ["sans-visage", "sans visage", "faceless men"], x: ["Les Immaculés", "La Garde de Nuit", "Les Fils de la Harpie"] },
  ...
  { id: "got-p16", d: 4, t: "Quel fils Greyjoy est torturé par Ramsay et renommé « Reek » ?", a: "Theon Greyjoy", acc: ["theon", "reek", "schlingue"], x: ["Balon", "Euron", "Yara"] },
  { id: "got-p17", d: 4, t: "Quel bâtard sadique de la maison Bolton torture Theon ?", a: "Ramsay Bolton", acc: ["ramsay"], x: ["Roose", "Walder", "Joffrey"] },
  { id: "got-p18", d: 4, t: "Quelle maison règne sur Dorne ?", a: "Martell", x: ["Tyrell", "Tully", "Arryn"] },
