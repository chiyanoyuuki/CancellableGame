...
export const friends = universe("series", "Friends", [
  ...
  { id: "friends-d13", d: 3, t: "Combien de bébés Phoebe porte-t-elle pour son frère ?", a: "3", acc: ["3", "trois", "triples", "triplés"], x: ["1", "2", "4"] },
  ...
  // --- Pro (20) ---
  { id: "friends-p1", d: 4, t: "Qui Phoebe finit-elle par épouser ?", a: "Mike Hannigan", acc: ["mike", "mike hannigan"], x: ["David", "Gary", "Frank"] },
  ...
  { id: "friends-p15", d: 4, t: "Quel homme plus âgé à moustache Monica fréquente-t-elle ?", a: "Richard", x: ["Pete", "Mike", "Gary"] },
  { id: "friends-p16", d: 4, t: "Dans quel pays a lieu le mariage raté de Ross et Emily ?", a: "En Angleterre", acc: ["angleterre", "londres", "royaume-uni"], x: ["En France", "Aux États-Unis", "En Écosse"] },
  ...
  { id: "friends-p19", d: 4, t: "Dans quelle ville Rachel a-t-elle un poste qu'elle renonce à prendre ?", a: "Paris", x: ["Milan", "Londres", "New York"] },
  { id: "friends-p20", d: 4, t: "Combien d'enfants Ross a-t-il au total ?", a: "2", acc: ["deux"], x: ["1", "3", "0"] },
]);
