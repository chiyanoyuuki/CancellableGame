...
export const theboys = universe("series", "The Boys", [
  // --- Faciles (5) ---
  { id: "boys-f1", d: 1, t: "Comment s'appelle le groupe de super-héros stars et corrompus ?", a: "Les Sept", acc: ["les sept", "the seven", "sept"], x: ["Les Vengeurs", "La Ligue", "Les X-Men"] },
  { id: "boys-f2", d: 1, t: "Quelle entreprise gère et commercialise les super-héros ?", a: "Vought", acc: ["vought"], x: ["Stark", "Umbrella", "Oscorp"] },
  { id: "boys-f3", d: 1, t: "Quel est le leader psychopathe des Sept ?", a: "Homelander", acc: ["homelander", "le protecteur", "protecteur"], x: ["A-Train", "Black Noir", "Butcher"] },
  ...
  { id: "boys-m7", d: 2, t: "Quel membre des Boys, père de famille, est surnommé « Mother's Milk » ?", a: "MM", acc: ["mm", "mother's milk", "mothers milk"], x: ["Frenchie", "Hughie", "Butcher"] },
  ...
  { id: "boys-d5", d: 3, t: "Quelle nouvelle héroïne des Sept se révèle être une nazie ?", a: "Stormfront", x: ["Maeve", "Starlight", "Firecracker"] },
  { id: "boys-d6", d: 3, t: "Quelle est la vraie nature de Stormfront ?", a: "Une nazie centenaire", acc: ["nazie", "centenaire", "vieille nazie"], x: ["Une IA", "Une extraterrestre", "Un clone"] },
  ...
  { id: "boys-d9", d: 3, t: "Quel PDG noir, calme et impitoyable, dirige Vought ?", a: "Stan Edgar", acc: ["stan edgar", "edgar"], x: ["Stillwell", "Ashley", "Adam"] },
  ...
  { id: "boys-d13", d: 3, t: "Comment s'appelle la dose de pouvoirs temporaires introduite en saison 3 ?", a: "Le V temporaire", acc: ["temp v", "v temporaire"], x: ["Le Composé V", "Le sérum", "La NovaV"] },
  ...
  // --- Pro (20) ---
  { id: "boys-p1", d: 4, t: "Qui est le showrunner The Boys ?", a: "Eric Kripke", acc: ["eric kripke", "kripke"], x: ["Garth Ennis", "Seth Rogen", "Evan Goldberg"] },
  ...
  { id: "boys-p8", d: 4, t: "Quelle secte manipule les super-héros ?", a: "L'Église du Collectif", acc: ["eglise du collectif", "the church of the collective", "collectif"], x: ["La Scientologie", "Les Témoins", "L'Ordre"] },
  { id: "boys-p9", d: 4, t: "Qui tue Madelyn Stillwell ?", a: "Homelander", x: ["Butcher", "Starlight", "A-Train"] },
  ...
  { id: "boys-p15", d: 4, t: "Comment Homelander révèle-t-il sa vraie nature à la foule ?", a: "Il tue un manifestant au laser devant tout le monde", acc: ["il tue un manifestant", "laser sur un manifestant", "tue un homme"], x: ["Il démissionne", "Il s'excuse", "Il disparaît"] },
  ...
  { id: "boys-p19", d: 4, t: "Quel effet secondaire le V temporaire provoque-t-il chez Butcher et Hughie ?", a: "Des tumeurs au cerveau", acc: ["tumeurs", "tumeurs au cerveau", "ca les tue"], x: ["Rien", "La folie seulement", "La perte de mémoire"] },
