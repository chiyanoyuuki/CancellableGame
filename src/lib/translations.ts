...
export const EN: Record<string, string> = {
  ...
  'Aucune question disponible': 'No questions available',
  'Reviens un peu plus tard pour la question du jour.': 'Come back a little later for the question of the day.',
  'Impossible de préparer la partie.': 'Could not set up the game.',
  ...
  // --- Saisons (classement mensuel) -----------------------------------------
  Saisons: 'Seasons',
  'Un classement qui repart chaque mois': 'A leaderboard that resets each month',
  'Le classement du mois et les champions passés.': 'This month’s ranking and past champions.',
  'Saison en cours · {month}': 'Current season · {month}',
  'Pas encore de partie ce mois-ci': 'No games this month yet',
  'Jouez pour lancer la course au titre !': 'Play to kick off the title race!',
  '{w} victoires · {g} parties': '{w} wins · {g} games',
  'Champions des saisons passées': 'Past season champions',
  '{w} victoires': '{w} wins',
